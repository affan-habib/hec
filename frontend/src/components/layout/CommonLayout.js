...
const CommonLayout = ({ children }) => {
  ...
  const isPublicRoute = pathname === '/' || pathname === '/auth/login' || pathname === '/auth/register' || pathname.startsWith('/main');
  ...
  return (
    <div className="flex h-screen bg-gray-100 dark:bg-gray-900 ease-in-out">
      <CommonSidebar onToggle={(collapsed) => setIsSidebarCollapsed(collapsed)} />
      <div
