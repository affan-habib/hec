...
import { FiUser, FiMail, FiEdit, FiSave, FiAlertCircle, FiBriefcase, FiUpload } from 'react-icons/fi';
                  ...
                  <div className="md:col-span-2 space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <ErrorMessage name="department" component="div" className="mt-1 text-sm text-red-600 dark:text-red-400" />
                      </div>
                    </div>
